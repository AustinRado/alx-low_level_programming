...
/**
* check_elf - entry point, checks if it is an elf file
* @e_ident: pointer to array containing ELF Version
*
* Desc: Exit if is not ELF file with 98
*
*/
 ...
 * @e_ident: pointer to array containing ELF version
 *
 * Desc: numbers separated by spaces.
 */
 ...
 * @e_ident: pointer to array containingELF version.
 */
 ...
 * Return: 0
 *
 * Desc: If the file is not an ELF File or the
